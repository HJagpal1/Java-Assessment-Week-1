...
public class OfflineExercises {
	...
	public String multChar(String input) {
		 ...
		 * First Attempt
		 * 
		 * String string = new multChar ("Hi-There "); String string = new
		 * String("Hi-There"); for (int i = 0; i < string.length(); i++) {
		 * 
		 * }
		 **/
...
//		System.out.println("Is " + a + " divisble by " + b + " : " + isDivisible(a, b));
	}

	public static boolean isDivisible(int arg1, int divider) {
		System.out.println(arg1 % divider == 0);
		return arg1 % divider == 0;
		// System.out.println("Is " + a + " divisble by " + b + " : " + isDivisible(a,
		// b));
		// return null;
